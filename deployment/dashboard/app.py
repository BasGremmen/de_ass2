...
def visualize(broker):
    # Perform a query.
    QUERY = (
        'SELECT count, time_frame.end FROM `glass-sylph-325109.ass2.trades` WHERE broker = "' + broker + '" ORDER BY time_frame.end DESC LIMIT 100')  # use the correct project id, etc.
